 ...
 *
 */
package edu.usu.cosl.syndication.feed.module;
...
public class DCTermsModuleImpl extends ModuleImpl implements DCTermsModule {
    ...
    private List _date;
    private List _created_date;
    private List _modified_date;
    private List _type;
    ...
    public DCTermsModuleImpl() {
        ...
        _objBean = new ObjectBean(DCTermsModule.class, this, CONVENIENCE_PROPERTIES);
    }
    ...
    public void setCreatedDates(List dates) {
        _created_date = dates;
    }
    public void setModifiedDates(List dates) {
        _modified_date = dates;
    }
    ...
    public Date getCreatedDate() {
        return ((_created_date != null) && (_created_date.size() > 0)) ?
                (Date) _created_date.get(_created_date.size()-1) : null;
    }
    public List getCreatedDates() {
        return (_created_date == null) ? (_created_date = new ArrayList()) : _created_date;
    }
    public Date getModifiedDate() {
        return ((_modified_date != null) && (_modified_date.size() > 0)) ?
                (Date) _modified_date.get(0) : null;
    }
    public List getModifiedDates() {
        return (_modified_date == null) ? (_modified_date = new ArrayList()) : _modified_date;
    }
    ...
    static {
        ...
        basePropInterfaceMap.put("createdDates", Date.class);
        basePropInterfaceMap.put("modifiedDates", Date.class);
        ...
        COPY_FROM_HELPER = new CopyFromHelper(DCTermsModule.class, basePropInterfaceMap, null);
    }
}
